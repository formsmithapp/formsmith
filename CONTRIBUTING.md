...
- **Your contribution to open packages always stays open** under that package's license, permanently
  — a promise made publicly in the [Open-Core Covenant](OPEN-CORE-COVENANT.md).
