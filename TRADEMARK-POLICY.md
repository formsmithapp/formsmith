# Formsmith Trademark Policy (v1.0)
...
- **Write, teach, and publish** about Formsmith using the name and screenshots.
- **Redistribute unmodified builds** and refer to them as Formsmith.
...
- Use the marks in any way that **implies affiliation, endorsement, or official status**
  that doesn't exist.
- Register trademarks, domains, or social handles **confusingly similar** to Formsmith.

## Attribution

Where attribution is appropriate, use: *"Formsmith is a trademark of Gnana Siva Sai V."*
(This line will be updated if the project's ownership transfers to a legal entity.)

## Permission and questions

Email gnana097@gmail.com. Permission requests are usually answered quickly and granted
where use is honest and non-confusing.
